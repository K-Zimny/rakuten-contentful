...
/** [See type definition](https://app.contentful.com/spaces/rdr91vdz2nv7/content_types/componentAuthor) */
...
/** [See type definition](https://app.contentful.com/spaces/rdr91vdz2nv7/content_types/componentQuote) */
export type ComponentQuoteAuthorArgs = {
  locale?: InputMaybe<Scalars['String']['input']>;
  useFallbackLocale?: InputMaybe<Scalars['Boolean']['input']>;
};
...
/** [See type definition](https://app.contentful.com/spaces/rdr91vdz2nv7/content_types/componentQuote) */
export type ComponentQuoteTextArgs = {
  locale?: InputMaybe<Scalars['String']['input']>;
  useFallbackLocale?: InputMaybe<Scalars['Boolean']['input']>;
};
...
/** [See type definition](https://app.contentful.com/spaces/rdr91vdz2nv7/content_types/componentRichImage) */
...
/** [See type definition](https://app.contentful.com/spaces/rdr91vdz2nv7/content_types/componentSeo) */
...
/** [See type definition](https://app.contentful.com/spaces/rdr91vdz2nv7/content_types/pageBlogPost) */
...
/** [See type definition](https://app.contentful.com/spaces/rdr91vdz2nv7/content_types/quote) */
export type Quote = Entry & _Node & {
  __typename?: 'Quote';
  _id: Scalars['ID']['output'];
  contentfulMetadata: ContentfulMetadata;
  linkedFrom?: Maybe<QuoteLinkingCollections>;
  quoteAuthor?: Maybe<Scalars['String']['output']>;
  quoteName?: Maybe<Scalars['String']['output']>;
  sys: Sys;
};
...
/** [See type definition](https://app.contentful.com/spaces/rdr91vdz2nv7/content_types/quote) */
export type QuoteQuoteAuthorArgs = {
  locale?: InputMaybe<Scalars['String']['input']>;
  useFallbackLocale?: InputMaybe<Scalars['Boolean']['input']>;
};
...
/** [See type definition](https://app.contentful.com/spaces/rdr91vdz2nv7/content_types/quote) */
export type QuoteQuoteNameArgs = {
  locale?: InputMaybe<Scalars['String']['input']>;
  useFallbackLocale?: InputMaybe<Scalars['Boolean']['input']>;
};
...
export type QuoteFilter = {
  ...
  quoteName_contains?: InputMaybe<Scalars['String']['input']>;
  quoteName_exists?: InputMaybe<Scalars['Boolean']['input']>;
  quoteName_in?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
  quoteName_not?: InputMaybe<Scalars['String']['input']>;
  quoteName_not_contains?: InputMaybe<Scalars['String']['input']>;
  quoteName_not_in?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
  sys?: InputMaybe<SysFilter>;
};
...
export enum QuoteOrder {
  ...
  QuoteNameAsc = 'quoteName_ASC',
  QuoteNameDesc = 'quoteName_DESC',
  SysFirstPublishedAtAsc = 'sys_firstPublishedAt_ASC',
  SysFirstPublishedAtDesc = 'sys_firstPublishedAt_DESC',
  SysIdAsc = 'sys_id_ASC',
  SysIdDesc = 'sys_id_DESC',
...
/** [See type definition](https://app.contentful.com/spaces/rdr91vdz2nv7/content_types/test) */
...
export type TestFilter = {
  ...
  contentfulMetadata?: InputMaybe<ContentfulMetadataFilter>;
  sys?: InputMaybe<SysFilter>;
  testRef_exists?: InputMaybe<Scalars['Boolean']['input']>;
};
...
export const RichImageFieldsFragmentDoc = gql`
  ...
  fullWidth
    ...
    `;
export const RichQuoteFieldsFragmentDoc = gql`
    fragment RichQuoteFields on ComponentQuote {
  __typename
  sys {
    id
  }
